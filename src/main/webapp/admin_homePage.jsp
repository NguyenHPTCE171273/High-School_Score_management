        ...
        <main class="container">
            <div class="row mt-5">
                <a style="text-decoration: none" class="col-sm-12 col-md-6 col-lg-3 text-center" href="">
                    ...
                    <p style="color: #003a5f">List of teachers</p>
                </a>
                <a style="text-decoration: none" class="col-sm-12 col-md-6 col-lg-3 text-center" href="">
                ...
                <a style="text-decoration: none" class="col-sm-12 col-md-6 col-lg-3 text-center" href="">
                    ...
                    <p style="color: #003a5f">List of classes</p>
                </a>
                <a style="text-decoration: none" class="col-sm-12 col-md-6 col-lg-3 text-center" href="">
            ...
            <div class="row mt-5">
                <a href="" style="text-decoration: none" class="col-sm-12 col-md-6 col-lg-3 text-center" >
